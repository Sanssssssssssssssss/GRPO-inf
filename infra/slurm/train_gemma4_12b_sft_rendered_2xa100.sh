...
#SBATCH --job-name=gemma4-12b-sft-rendered
#SBATCH --nodes=1
...
RUN_ID="${RUN_ID:-gemma4_12b_sft_rendered_canary_${SLURM_JOB_ID:-manual}}"
CONFIG_PATH="${CONFIG_PATH:-configs/training/gemma4_12b_sft_rendered_canary.json}"
