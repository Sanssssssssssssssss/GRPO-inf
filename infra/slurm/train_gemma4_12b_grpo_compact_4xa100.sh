...
#SBATCH --job-name=gemma4-12b-grpo-compact
#SBATCH --nodes=1
...
RUN_ID="${RUN_ID:-gemma4_12b_grpo_compact_${SLURM_JOB_ID:-manual}}"
CONFIG_PATH="${CONFIG_PATH:-configs/training/gemma4_12b_grpo_compact_canary.json}"
